...
req = {
    "nb_conda_kernels", "pip", "ipython", "tqdm", "numpy", "scipy", "pandas",
    "matplotlib", "ipywidgets", "pulp-utils", "pulp", "scikit-opt"
}
env_name = "jcop-or"
working_folder = "operations_research_and_optimization"
